...
<div align="center">
    ...
    <h1><fmt:message key="label.courseEditForm"/></h1>
    <form action=<%=request.getContextPath()%>"/edit-course" method="post">
        <table style="with: 80%">
            <tr>
                <td><fmt:message key="label.name"/></td>
                <td><input type="text" id="form2Example3" required placeholder="Name" name="name" class="form-control" /></td>
            </tr>
            <tr>
                <td><fmt:message key="label.duration"/></td>
                <td><input type="text" id="form2Example4" required placeholder="Duration" name="duration" class="form-control" /></td>
            </tr>
            <tr>
                <td><fmt:message key="label.theme"/></td>
                <td><input type="text" id="form2Example1" required placeholder="Theme" name="theme" class="form-control" /></td>
            </tr>
        </table>
