...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="nav-link active" href="/user_menu.jsp"><fmt:message key="label.home"/></a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" href="teacher_courses.jsp"><fmt:message key="label.courses"/></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="/profile"><fmt:message key="label.profile"/></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="/course-list"><fmt:message key="label.myStudies"/></a>
                </li>
                <li class="nav-item">
                        ...
                        >
                            <div class="btn-group">
                                ...
                                <a
                                        type="button"
                                        class="btn btn-sm btn-outline-secondary"
                                        href="reg-for-course?userId=<%=userId%>&courseId=<%=p.getId()%>&viewid=user_courses.jsp"
                                >
